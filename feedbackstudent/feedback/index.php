    ...
    <div class="bg">
        ...
        <div class="card-deck">
            ...
            <!-- <div class="card">
                ...
                <form action="parentlogin.php" method="post">
                    <img class="card-img-top" src="images/parent.png" alt="Card image cap"
        ...
        <div class="card-deck"> -->
            ...
            <!-- <div class="card">
                ...
                <br>
                <form action="#" method="post">
                    <img class="card-img-top" src="images/Alumni.png" alt="Card image cap"
                        style="height:125px; width:130px">
                    <div class="card-body">
                        <div class="social-auth-links text-center mb-3">
                            <input type="submit" class="btn btn-block btn-primary" value=" Login " name="btnlink">
            ...
            <!-- <div class="card">
                ...
                <br>
                <form action="#" method="post">
                    <img class="card-img-top" src="images/employer.png" alt="Card image cap"
