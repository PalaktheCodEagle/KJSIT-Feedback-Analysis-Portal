...
<table id="myTable"  class="table table-striped table-bordered" >
	...
	while($rs = mysqli_fetch_array($qsql))
	{
		...
		// year
		$sqlyear = "SELECT * FROM years where years_id='$rs[years_id]'";
		$qsqlyears = mysqli_query($con,$sqlyear);
		$rsyears = mysqli_fetch_array($qsqlyears);
		...
		echo "<tr>
				...
				<td>" . $rsyears['years_description'] . "</td>
				<td>$rs[section]</td>
				<td>$rs[status]</td>
				<td style='width: 75px;'><a href='student.php?editid=$rs[0]' class='btn btn-info' style='width: 75px;'>Edit</a> 
				</td><td>
				
				<a href='viewstudent.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' style='width: 75px;' >Delete</a></td>
			</tr>";
	}
	?>
	</tbody>
