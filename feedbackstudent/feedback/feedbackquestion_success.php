                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rsstudent['studentname']; ?></td>
                                </tr>
                                <tr>
                                    <th>Roll No:</th>
                                    <td><?php echo $rsstudent['rollno']; ?></td>
                                </tr>
                                <tr>
                                    <th>Department:</th>
                                    <td><?php
...
echo $rscourse['course_title']; ?> </td>
                                </tr>
                                <tr>
                                    <th>Year / Division:</th>
                                    <td><?php
$sqlyears = "SELECT * FROM years where years_id='$rsstudent[years_id]'";
$qsqlyears = mysqli_query($con,$sqlyears);
$rsyears = mysqli_fetch_array($qsqlyears);
echo $rsyears['years_description']; ?> / <?php echo $rsstudent['section']; ?> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
