...
if (!isset($_SESSION['adminid']) && !isset($_SESSION['studentid'])) {
    // Consider displaying a message instead of redirecting
    echo "<script>window.location='../../index.php';</script>";
...
// Fetch admin data if admin session is set
if (isset($_SESSION['adminid'])) {
    ...
    if (!$qsqladmin) {
        // Handle query error more gracefully
...
// Fetch student data if student session is set
if (isset($_SESSION['studentid'])) {
    $studentid = mysqli_real_escape_string($con, $_SESSION['studentid']);
