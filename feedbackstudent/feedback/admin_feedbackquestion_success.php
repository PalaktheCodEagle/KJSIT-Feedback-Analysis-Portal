...
<form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?php $sidemenu; ?> STUDENT DETAILS</h3>
        </div>
        <div class="card-body">
...
<table class="table table-bordered">
	...
	<tr>
		<th>Roll no. </th><td><?php echo $rsstudent['rollno']; ?></td>
	</tr>
	<tr>
		<th>Class :</th><td><?php
...
<form method="post" action="" onsubmit="return confirmvalidation2()" enctype="multipart/form-data">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">VIEW FEEDBACK QUESTIONS AND ANSWERS</h3>
        </div>
        <div class="card-body">
...
<form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">FEEDBACK QUESTION DETAILS</h3>
        </div>
        <div class="card-body">
