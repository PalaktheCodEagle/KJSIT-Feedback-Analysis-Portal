		...
		<form method="post" action="" onsubmit="return confirmvalidation1()" enctype="multipart/form-data">
			...
			<div class="card">
				<div class="card-header">
					<h3 class="card-title"><b>FEEDBACK TOPIC</b></h3>
				</div>
				<div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<select class="form-control" name="section" id="section">
								...
								<?php
								$sql2 = "SELECT DISTINCT(section) FROM `student` WHERE status='Active' and LENGTH(section) = 1 order by section ASC";
						...
						?>
						<!--</select>
							<span id="facultyError" class="error" style="display: none;"></span>
						</div> -->
						<!-- <div class="form-group col-md-6">
			...
			<div class="card-footer">
				...
				<div class="row">
					...
					?>
						<div class="col-md-4">
							<input class="form-control" type="submit" name="submit" id="submit" value="Update Question Paper" style="background-color: #9b2928;color:white">
						</div>
	...
	?>
		...
		<section class="content">
			<form method="post" action="" onsubmit="return confirmvalidation1()" enctype="multipart/form-data">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title"><b>ADD FEEDBACK QUESTIONS</b></h3>
					</div>
					<div class="card-body">
					...
					<div class="card-footer">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<input class="form-control" type="submit" name="submitquestion" id="submitquestion" value="Add Question" style="background-color: #9b2928;color:white">
							</div>
							<div class="col-md-4"></div>
						</div>
					</div>
		...
		<section class="content">
			<form method="post" action="" onsubmit="return confirmvalidation2()" enctype="multipart/form-data">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title"><b>VIEW FEEDBACK QUESTIONS </b></h3>
					</div>
					<div class="card-body">
										...
										<td>
											...
											?>
												<div class="row">
													<div class="col-md-6">
														...
														<b>Option 1*</b>
														<textarea class="form-control" name="edoption1" id="edoption1"><?php echo $rsqz['option1']; ?></textarea>
												...
												<div class="row">
													<div class="col-md-6">
														<b>Option 7</b>
														<textarea class="form-control" name="edoption7" id="edoption7"><?php echo $rsqz['option7']; ?></textarea>
														<span class="errmsg flash" id="erredoption7" style="color: red;"></span>
													</div>
													<div class="col-md-6">
														<b>Option 8</b>
														<textarea class="form-control" name="edoption8" id="edoption8"><?php echo $rsqz['option8']; ?></textarea>
												...
												<div class="row">
													<div class="col-md-6">
														<b>Option 9</b>
														<textarea class="form-control" name="edoption9" id="edoption9"><?php echo $rsqz['option9']; ?></textarea>
											...
											<div class="card-footer">
												...
												<div class="row">
													<div class="col-md-4"></div>
													<div class="col-md-4">
														<input class="form-control" type="submit" name="btnupdatequestion" id="submitquestion" value="Click here to update" style="background-color: #9b2928;color:white">
													</div>
...
<script>
	...
	// document.getElementById('faculty_id').addEventListener('change', validateFaculty);
	...
	function confirmvalidation1() {
		...
		// else if (!document.getElementById('faculty_id').value.match(phoneRegexMax10Degit)) {
		// 	fieldValidation1();
		// 	document.getElementById('faculty_id').focus();
		// 	document.getElementById('faculty_id').scrollIntoView({
		// 		behavior: 'smooth'
		// 	});
		// 	isValid = false;
		// } 
	...
	function validateFeedbackTopic() {
		if (document.getElementById('feedback_topic').value === '') {
			document.getElementById('feedbacktopicerror').textContent = 'Feedback Topic Name should not be empty.';
	...
	function validateFeedbackTopicDetail() {
		if (document.getElementById('feedbacktopic_detail').value === '') {
			document.getElementById('feedbacktopicdetailError').textContent = 'Feedback Topic Description should not be empty';
	...
	// 		document.getElementById('facultyError').textContent = 'Section should not be empty';
