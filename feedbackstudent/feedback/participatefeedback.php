    ...
    <section class="content">
        <form method="post" action="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php
//$sql = "SELECT * FROM `feedbacktopic` WHERE course_id=(select course_id from student where studentid = $_SESSION[studentid]) and section_name=(select section from student where studentid = $_SESSION[studentid]) and year_id=(select year_id from student where studentid = $_SESSION[studentid]);";
