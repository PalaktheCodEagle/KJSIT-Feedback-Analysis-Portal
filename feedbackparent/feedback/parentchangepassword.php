...
if (isset($_POST['submit'])) {
	$sql = "UPDATE parent SET password='$_POST[npassword]' WHERE parentid='$_SESSION[parentid]' and password='$_POST[opassword]'";
	$qsql = mysqli_query($con, $sql);
	echo mysqli_error($con);
	if (mysqli_affected_rows($con) == 1) {
		echo "<script>alert('Parent password Updated successfully...');</script>";
		echo "<script>window.location='parentchangepassword.php';</script>";
	} else {
