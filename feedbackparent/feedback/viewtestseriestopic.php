                ...
                <div class="card-body">
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
							...
							if (isset($_SESSION['parentid']) && $_GET['qtype'] == "Single") {
								$sql = $sql . " AND parentid='$_SESSION[parentid]'";
							}
							if ($_GET['qtype'] == "All") {
                            ...
                            <?php echo $rsparent['rollno']; ?><br><b>Class-
                            </b><?php echo $rsparent['parentclass']; ?> (<?php echo $rsparent['section']; ?>)
                            <?php
								} else {
								?>
                            ...
                            <td style='width:70px;'><a href=""
                                    onclick="funloadtestseries('<?php echo $rs[0]; ?>','<?php echo $rs['testseries_topic']; ?>')"
                                    data-toggle="modal" data-target="#exampleModal" class="btn btn-warning">View <br>&nbsp;(<?php
