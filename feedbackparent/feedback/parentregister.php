...
if (isset($_SESSION['parentid'])) {
    echo "<script>window.location='parentdashboard.php';</script>";
}
...
if (isset($_POST['submit'])) {
    $sql = "INSERT INTO parent SET parentname='" . $_POST['parentname'] . "',email_id='" . $_POST['email_id'] . "',studentname='" . $_POST['studentname'] . "',companyname='" . $_POST['companyname'] . "',companyaddress='" . $_POST['companyaddress'] . "',dateofbirth='" . $_POST['dateofbirth'] . "',designation='" . $_POST['designation'] . "',occupation='" . $_POST['occupation'] . "',password='" . $_POST['password'] . "',section='" . $_POST['section'] . "',rollno='" . $_POST['rollno'] . "',years_id='" . $_POST['courseyear'] . "',course_id='" . $_POST['course'] . "',parent_no='" . $_POST['parent_no'] . "',status='Inactive', academicyear='2022-23' ";
    ...
    if (mysqli_affected_rows($con) == 1) {
        //     $message = "Welcome $_POST[parentname],<br>
        // Click the following link to verify your email: <a href='$url/feedbackparent/feedback/parentemailverify.php?code=$verificationCode'>Verify Email</a>";
        $message = "Dear $_POST[parentname],<br><br>
...
<br><br>
<a href='$url/new/feedbackparent/feedback/parentemailverify.php?code=$verificationCode'>Verify Account</a>
<br><br>
...
KJSIT Stakeholders Feedback Analysis Team.";
        ...
        sendmail($_POST['email_id'], $_POST['parentname'], "Account Verification for KJSIT Stakeholders Feedback System", $message);

        $sql = "UPDATE `parent` SET verification_code='" . $verificationCode . "' WHERE `email_id`='" . $_POST['email_id'] . "'";
        mysqli_query($con, $sql);

        echo "<script>alert('Please check your registed email for to verify your account in the parent Feedback Portal. Thank you.');</script>";
...
<head>
    ...
    <title>Parent Feedback - Parent Registration Window</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="heading">
            ...
            <h1 style="font-weight: bold; margin-bottom:0px ">Parent Registration</h1>
        </div>
        ...
        <div class="main1">
            <div class="container">
                ...
                <br>
                <div class="text-center font-weight-bolder" style="font-size: larger;">Ward Details</div>
                <div class="content">
                    <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data"
                        autocomplete="off">
                        <div class="col-12">
                            <label for="inputAddress" class="form-label">Ward Full Name</label>
                            <input type="text" class="form-control" name="studentname" id="studentname"
                                placeholder="Enter Your Full Name" value="<?php if (isset($rsedit['studentname'])) {
    echo $rsedit['studentname'];
                        ...
                        <br>
                        <div class="col-12">
                            <label for="inputRollNo" class="form-label">Ward Roll No.</label>
                            <input type="text" class="form-control" name="rollno" id="rollno"
                                placeholder="Enter Ward Roll No." value="<?php if (isset($rsedit['rollno'])) {
    echo $rsedit['rollno'];
}?>">
                            <span id="rollnoError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="inputDOB" class="form-label">Ward Date Of Birth</label>
    ...
    echo $rsedit['dateofbirth'];
                        ...
                        <div class="col-md-12" style="height: auto;">
                            <label for="inputDOB" class="form-label">Ward Course</label>
...
?>
                        ...
                        <br>
                        <div class="col-md-12">
                            <label for="input year">Ward Course Year</label>
...
?>
                        ...
                        <br>
                        <div class="col-md-12">
                            <label for="input section">Ward Section</label>
                            <input type="text" class="form-control" name="section" id="section"
                                placeholder="Enter Your Section" value="<?php if (isset($rsedit['section'])) {
    echo $rsedit['section'];
}?>">
                            <span id="sectionError" class="error" style="display: none;"></span>
                        </div>
                        <br><br>
                        <div class="text-center font-weight-bolder" style="font-size: larger;">Parent/Gaurdian Details
                        </div>

                        <div class="col-12">
                            <label for="inputAddress" class="form-label">Full Name</label>
                            <input type="text" class="form-control" name="parentname" id="parentname"
                                placeholder="Enter Your Full Name" value="<?php if (isset($rsedit['parentname'])) {
    echo $rsedit['parentname'];
}?>">
                            <span id="parentnameError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
    ...
    echo $rsedit['email_id'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="designation" placeholder="Enter Designation"
                                id="designation" value="<?php if (isset($rsedit['designation'])) {
    echo $rsedit['designation'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="occupation" placeholder="Enter Occupation"
                                id="occupation" value="<?php if (isset($rsedit['occupation'])) {
    echo $rsedit['occupation'];
}?>">
                            <span id="occupationError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="inputcompanyname" class="form-label">Company Name</label>
                            <input type="text" class="form-control" name="companyname" placeholder="Enter Company Name"
                                id="companyname" value="<?php if (isset($rsedit['companyname'])) {
    echo $rsedit['companyname'];
}?>">
                            <span id="companynameError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="companyaddress"
                                placeholder="Enter Company Address" id="companyaddress" value="<?php if (isset($rsedit['companyaddress'])) {
    echo $rsedit['companyaddress'];
}?>">
                            <span id="companyaddressError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">parent's Contact</label>
                            <input type="text" class="form-control" name="parent_no" maxlength="10"
                                placeholder="Enter parent Contact" id="parent_no" value="<?php if (isset($rsedit['parent_no'])) {
    echo $rsedit['parent_no'];
}?>">
                            <span id="parentsnoError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
    ...
    document.getElementById('parentsnoError').textContent = '';
    document.getElementById('parentsnoError').style.display = 'none';
    ...
    function confirmvalidation() {
        ...
        if (document.getElementById('parentname').value === '') {
            ...
            document.getElementById('parentname').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
            ...
            document.getElementById('companyname').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
            ...
            document.getElementById('companyaddress').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        }
        ...
        //     isValid = false;
        // }
        else if (document.getElementById('parent_no').value === '') {
            fieldValidation();
            document.getElementById('parent_no').focus();
            document.getElementById('parent_no').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (!document.getElementById('parent_no').value.match(phoneRegexOnlyNo)) {
            fieldValidation();
            document.getElementById('parent_no').focus();
            document.getElementById('parent_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (!document.getElementById('parent_no').value.match(phoneRegexMax10Degit)) {
            fieldValidation();
            document.getElementById('parent_no').focus();
            document.getElementById('parent_no').scrollIntoView({
                behavior: 'smooth'
    ...
    function validateparentname() {
        if (document.getElementById('parentname').value === '') {
            document.getElementById('parentnameError').textContent = 'Original Name should not be empty.';
    ...
    function validateDesignation() {
        if (document.getElementById('designation').value === '') {
            document.getElementById('designationError').textContent = 'Designation should not be empty';
    ...
    function validateOccupation() {
        if (document.getElementById('occupation').value === '') {
            document.getElementById('occupationError').textContent = 'Occupation should not be empty';
    ...
    function validateCompanyname() {
        if (document.getElementById('companyname').value === '') {
            document.getElementById('companynameError').textContent = 'company Name should not be empty';
    ...
    function validateCompanyaddress() {
        if (document.getElementById('companyaddress').value === '') {
            document.getElementById('companyaddressError').textContent = 'company Address should not be empty';
    ...
    function validateparentNo() {
        if (document.getElementById('parent_no').value === '') {
            document.getElementById('parentsnoError').textContent = 'parent No should not be empty';
            document.getElementById('parentsnoError').style.display = 'block';
        } else if (!document.getElementById('parent_no').value.match(phoneRegexOnlyNo)) {
            document.getElementById('parentsnoError').textContent =
                'Please enter a valid phone number (digits and + only).';
            document.getElementById('parentsnoError').style.display = 'block';
        } else if (!document.getElementById('parent_no').value.match(phoneRegexMax10Degit)) {
            document.getElementById('parentsnoError').textContent = 'Please enter a valid 10-digit phone number.';
            document.getElementById('parentsnoError').style.display = 'block';
        } else {
            document.getElementById('parentsnoError').textContent = '';
            document.getElementById('parentsnoError').style.display = 'none';
    ...
    document.getElementById('parentname').addEventListener('change', validateparentname);
    ...
    document.getElementById('designation').addEventListener('change', validateDesignation);
    document.getElementById('occupation').addEventListener('change', validateOccupation);
    document.getElementById('companyname').addEventListener('change', validateCompanyname);
    document.getElementById('companyaddress').addEventListener('change', validateCompanyaddress);
    document.getElementById('parent_no').addEventListener('change', validateparentNo);
