    ...
    <section class="content">
        <form method="post" action="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php
					//$sql = "SELECT * FROM `feedbacktopic` WHERE course_id=(select course_id from parent where parentid = $_SESSION[parentid]) and section_name=(select section from parent where parentid = $_SESSION[parentid]) and year_id=(select year_id from parent where parentid = $_SESSION[parentid]);";
					$sql = "SELECT * FROM `feedbacktopic` WHERE course_id in ((select course_id from parent where parentid = $_SESSION[parentid]), (select course_id from course where course_title='All')) and section_name in ((select section from parent where parentid = $_SESSION[parentid]), 'all') and year_id in ((select year_id from parent where parentid = $_SESSION[parentid]), (select years_id from years where years_title='All'))";
		...
		<br>$rs[feedbacktopic_detail]";
						...
						echo "<td>";
						$sqlfeedbacktest = "select * from feedbackquestion_result WHERE feedbacktopicid='$rs[feedbacktopicid]' AND parentid='$_SESSION[parentid]'";
						$qsqlfeedbacktest = mysqli_query($con, $sqlfeedbacktest);
						if (mysqli_num_rows($qsqlfeedbacktest) >= 1) {
							echo "<a href='feedbackquestion_success.php?feedbacktopicid=$rs[0]&parentid=$_SESSION[parentid]' class='btn btn-success'  >View Entries</a>";
						} else {
