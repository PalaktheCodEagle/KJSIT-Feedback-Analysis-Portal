...
if (isset($_POST['btnsubmit'])) {
    $sql = "SELECT * FROM parent WHERE email_id='$_POST[email]' and status='Active'";
    ...
    if (mysqli_num_rows($qsql) >= 1) {
        ...
        // $message = "Hello $rspro[parentname],<br>
		// You have sent request to recover password. Kindly press below link to reset password...<br><br>
		// Visit Link - <b><a href='$url/feedbackparent/feedback/parentresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b><br>
		// ";
        //echo $rspro['rollno'];

        $message = "Dear $rspro[parentname],<br>
        <br>
        ...
        <br><br>
        Reset Password:<a href='$url/feedbackparent/feedback/parentresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b>
        <br><br>
        ...
        sendmail($rspro['email_id'], $rspro['parentname'], "Password Recovery Mail", $message);
...
<head>
    ...
    <title>Parent Feedback System - Parent Forgot Password Window</title>
