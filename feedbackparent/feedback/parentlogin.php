...
if (isset($_POST["btnsubmit"])) {
    $sql = "SELECT * FROM parent WHERE email_id='$_POST[emailid]' AND password='$_POST[loginpassword]' AND status='Active'";
    $qsql = mysqli_query($con, $sql);
    if (mysqli_num_rows($qsql) == 1) {
        $rs = mysqli_fetch_array($qsql);
        $_SESSION['parentid'] = $rs['parentid'];
        echo "<script>window.location='parentdashboard.php';</script>";
    } else {
...
<head>
    ...
    <title>Parent Feedback - Parent Login Window</title>
...
<body style="background-image: linear-gradient(#9b2a286b,#00000000), url(greybg.jpg); background-size: cover;">
    ...
    <div class="heading" style="width: fit-content;">

        <h1 style="font-weight: bold; color: #FFFFFF;margin: 0.5em; padding:10px" class="heading">Parent Login</h1>
    </div>
        ...
        <div class="container">
            <div class="forms">
                <div class="form login">
                    <p class="heading" style="background-color: #ffffff; border-bottom: 1px #9b2928 solid;"><span
                            class="title">Login</span></p>
                    <form action="" method="post">
                        <div class="input-field inputs">
                            <label for="email">Email</label>
                            <input type="text" name="emailid" id="emailid" class="form-control"
                                style="margin-top: 30px;" placeholder="Enter your email" required="required">
                            <i class="uil uil-envelope icon"></i>
                        </div><br>
                        <div class="input-field inputs">
                            <label for="email">Password</label>
                            <input type="password" name="loginpassword" id="loginpassword" style="margin-top: 30px;"
                        ...
                        <div class="checkbox-text form-check  ">
                            <div class="checkbox-content form-check-input" style="margin-top: 40px;">
                                <input type="checkbox" id="logCheck">
                                <label for="logCheck" class="text">Remember me</label>
                            </div>
                        </div>
                        <div class="forgot">
                            <a href="parentforgotpassword.php" class="text">Forgot password?</a>
                        </div>
                    ...
                    <div class="login-signup">
                        <span class="text" style=" font-size: 20px;">Not a member?
                            <a href="parentregister.php" class="text signup-link" style=" font-size: 20px;"><b>Signup
                                    Now</b></a>
                        </span>
                    </div>
                </div>
