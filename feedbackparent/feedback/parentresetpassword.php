...
if (isset($_POST['btnsubmit'])) {
    $sql = "UPDATE parent SET password='$_POST[npassword]' WHERE parentid='$_GET[id]'";
    $qsql = mysqli_query($con, $sql);
    echo mysqli_error($con);
    if (mysqli_affected_rows($con) >= 1) {
        echo "<script>alert('Password updated successfully...');</script>";
        echo "<script>window.location='parentlogin.php';</script>";
    }
}
//###
?>
...
<head>
    ...
    <title>Parent Feedback System - Parent Reset Password Window</title>
            ...
            <div class="container">
                ...
                <div class="forms">
                    <div class="form login">
                        ...
                        <form action="" method="post" id="frmparentresetpassword" onsubmit="return validateform()">
