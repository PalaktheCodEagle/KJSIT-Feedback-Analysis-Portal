            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM testseries_result WHERE testseriestopicid='$_GET[testseriestopicid]' GROUP BY testseriestopicid,parentid";
                            ...
                            while ($rs = mysqli_fetch_array($qsql)) {
                                ...
                                $sqlqz = "SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND parentid='$rs[parentid]' and selectedanswer = correctanswer ";
                                ...
                                $sqltestseries_result = "SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND parentid='$rs[parentid]'";
                                ...
                                echo "<tr>
				<td>$rsparent[parentname]</td>
				<td>$rsparent[rollno]</td>
				<td>";
                            ?>
