...
if (isset($_GET['delid'])) {
	...
	if (mysqli_affected_rows($con) == 1) {
		...
		echo "<script>window.location='viewfaculty1.php';</script>";
	}
}
?>
    ...
    <section class="content">
        <form method="post" action="">
            ...
            <div class="card">
				...
				<td><a href='faculty1.php?editid=$rs[0]' class='btn btn-info'>Edit</a> | <a href='viewfaculty1.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' >Delete</a></td>
			</tr>";
							}
							?>
                        </tbody>
