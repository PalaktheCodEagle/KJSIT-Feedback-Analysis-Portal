...
if (isset($_POST["btnsubmit"])) {
    $sql = "SELECT * FROM employee WHERE email_id='$_POST[emailid]' AND password='$_POST[loginpassword]' AND status='Active'";
...
<head>
    ...
    <title>Employee Feedback - Employee Login Window</title>
...
<body style="background-image: linear-gradient(#9b2a286b,#00000000), url(greybg.jpg); background-size: cover;">
    ...
    <div class="heading" style="width: fit-content;">
        ...
        <h1 style="font-weight: bold; color: #FFFFFF;margin: 0.5em; padding:10px" class="heading">Employee Login</h1>
    </div>
            ...
            <div class="forms">
                <div class="form login">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="forgot">
                            <a href="employeeforgotpassword.php" class="text">Forgot password?</a>
                        </div>
                    ...
                    <div class="login-signup">
                        <span class="text" style=" font-size: 20px;">Not a member?
                            <a href="employeeregister.php" class="text signup-link" style=" font-size: 20px;"><b>Signup
                                    Now</b></a>
                        </span>
                    </div>
                </div>
