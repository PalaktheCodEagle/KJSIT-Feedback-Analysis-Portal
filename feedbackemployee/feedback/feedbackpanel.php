...
if (!isset($_SESSION['date'])) {
    ...
    $sql1 = "select * from  feedbackquestion_result where feedbacktopicid = '$_SESSION[feedbacktopicid]' and employeeid = '$_SESSION[employeeid]'";
    if ($result1 = mysqli_query($con, $sql1)) {
        $rowcount = mysqli_num_rows($result1);
    }
    if ($rowcount > 0) {
        echo "<script>window.location='feedbackquestion_success.php?feedbacktopicid=$_SESSION[feedbacktopicid]&employeeid=$_SESSION[employeeid]';</script>";
    }
...
if (isset($_POST['submit'])) {
    ...
    while ($rs = mysqli_fetch_array($result)) {
        $rowcount = 0;
        $sql1 = "SELECT * from  feedbackquestion_result where feedbacktopicid = '$_SESSION[feedbacktopicid]' and feedbackquestionid = '$rs[0]' and employeeid = '$_SESSION[employeeid]'";
        if ($result1 = mysqli_query($con, $sql1)) {
            $rowcount = mysqli_num_rows($result1);
        }
        ...
        if ($rowcount > 0) {
            $sqlupd = "UPDATE feedbackquestion_result SET selectedanswer='$answer' WHERE feedbacktopicid = '$_SESSION[feedbacktopicid]' and feedbackquestionid = '$rs[0]' and employeeid = '$_SESSION[employeeid]'";
        } else {
            $sqlins = "INSERT INTO feedbackquestion_result SET feedbacktopicid='$_SESSION[feedbacktopicid]', employeeid='$_SESSION[employeeid]', feedbackquestionid='$rs[0]', selectedanswer='$answer'";
...
$sqlqz = "SELECT * FROM feedbackquestion WHERE feedbacktopicid='$_SESSION[feedbacktopicid]'";
    ...
    $sqlqz = "SELECT *FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$date1' AND employeeid='$_SESSION[employeeid]' and selectedanswer != ''";
...
include "footer.php";
?>
<div id="idansstatus"><?php $sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$_SESSION[dttim]' AND employeeid='$_SESSION[employeeid]' and selectedanswer != ''";
$qsqlqz = mysqli_query($con, $sqlqz);?><input type="hidden" name="answereedq" id="answereedq"
        value="<?php echo mysqli_num_rows($qsqlqz); ?>"><?php $sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$_SESSION[dttim]' AND employeeid='$_SESSION[employeeid]' and selectedanswer=''";
