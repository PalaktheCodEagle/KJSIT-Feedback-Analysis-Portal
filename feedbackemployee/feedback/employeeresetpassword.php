...
if (isset($_POST['btnsubmit'])) {
    $sql = "UPDATE employee SET password='$_POST[npassword]' WHERE employeeid='$_GET[id]'";
...
<head>
    ...
    <title>employee Feedback System - employee Reset Password Window</title>
            ...
            <div class="container">
                ...
                <div class="forms">
                    <div class="form login">
                        ...
                        <form action="" method="post" id="frmemployeeresetpassword" onsubmit="return validateform()">
