...
if (isset($_POST['btnsubmit'])) {
    $sql = "SELECT * FROM employee WHERE email_id='$_POST[email]' and status='Active'";
    ...
    if (mysqli_num_rows($qsql) >= 1) {
        ...
        // $message = "Hello $rspro[employeename],<br>
		// You have sent request to recover password. Kindly press below link to reset password...<br><br>
		// Visit Link - <b><a href='$url/feedbackemployee/feedback/employeeresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b><br>
		// ";
        //echo $rspro['rollno'];
        $message = "Dear $rspro[employeename],<br>
            <br>
            ...
            <br><br>
            Reset Password:<b><a href='$url/feedbackemployee/feedback/employeeresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b>
            <br><br>
        ...
        sendmail($rspro['email_id'], $rspro['employeename'], "Password Recovery Mail", $message);
...
<head>
    ...
    <title>employee Feedback System - employee Forgot Password Window</title>
