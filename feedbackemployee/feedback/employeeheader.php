...
error_reporting(0);
if (!isset($_SESSION['adminid']) && !isset($_SESSION['employeeid'])) {
...
if (isset($_SESSION['employeeid'])) {
    $sqlemployee = "SELECT * FROM employee WHERE employeeid='$_SESSION[employeeid]'";
...
<head>
    ...
    <title>Employee Panel - Employee Feedback System..</title>
...
if (isset($_SESSION['employeeid'])) {
    ?>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a href="employeelogout.php" class="dropdown-item">
