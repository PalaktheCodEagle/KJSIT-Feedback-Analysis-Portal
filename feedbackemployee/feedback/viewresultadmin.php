            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
$sql = "SELECT * FROM quiz_result GROUP BY employeeid";
...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    $sqlqz = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND employeeid='$rs[employeeid]' and selectedanswer = correctanswer ";
    ...
    $sqlquiz_result = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND employeeid='$rs[employeeid]'";
    ...
    echo "<tr>
				<td>";
    ?>
                            <b><?php echo $rsemployee['employeename']; ?></b><br><b>Email - </b>
                            <?php echo $rsemployee['email_id']; ?>
                            <?php
echo "</td>
				<td>";
    ?>
                            <?php echo $rsemployee['employeeclass']; ?>
...
echo "</td>
    ...
    echo "<td><a href='quiz_result.php?quiztopicid=$rs[quiztopicid]&employeeid=$rs[employeeid]' class='btn btn-info'>View</a> </td>";
    echo "</tr>";
}
?>
                        </tbody>
