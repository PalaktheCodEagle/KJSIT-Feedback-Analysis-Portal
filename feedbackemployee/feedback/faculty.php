...
if (isset($_POST['submit'])) {
	...
	if (isset($_GET['editid'])) {
		...
		if (mysqli_affected_rows($con) == 1) {
			...
			echo "<script>window.location='faculty1.php';</script>";
		}
	}
}
if (isset($_GET['editid'])) {
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" name="faculty_name" id="faculty_name" value="<?php if (isset($rsedit['faculty_name'])) {
																														echo $rsedit['faculty_name'];
																													} ?>" />
						</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" name="faculty_designation" id="faculty_designation" value="<?php if (isset($rsedit['faculty_designation'])) {
																																	echo $rsedit['faculty_designation'];
																																} ?>" />
						</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<input type="file" class="form-control" name="faculty_img" id="faculty_img" value="<?php if (isset($rsedit['faculty_img'])) {
																													echo $rsedit['faculty_img'];
																												} ?>" />
							<?php
						...
						<div class="col-md-4"><span class="errmsg flash" id="errfaculty_img" style="color: red;"></span>
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-md-5">
							<textarea class="form-control" name="faculty_profile" id="faculty_profile"><?php if (isset($rsedit['faculty_profile'])) {
																											echo $rsedit['faculty_profile'];
																										} ?></textarea>
						</div>
