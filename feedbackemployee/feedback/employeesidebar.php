  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    background-color: #001c30;
      ...
      <div class="sidebar">
        ...
        <div class="image">
          <img src="<?php 
		  if($rsemployee['profileimg'] == "")
		  {
			  echo "images/defaultimg.png";
		  }
		  else if(!file_exists($rsemployee['profileimg']))
		  {
			  echo "images/defaultimg.png";
		  }
		  else
		  {
		  echo $rsemployee['profileimg']; 
		  }
		  ?>" class="img-circle elevation-2" alt="<?php echo $rsemployee['employeename']; ?>">
          </div>
          */
          ?>
          <div class="info">
              <b><a href="employeeprofile.php" class="d-block">Welcome
                      <?php echo $rsemployee['employeename']; ?></a></b>
          </div>
      </div>
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview">
                  <a href="employeedashboard.php" class="nav-link">
