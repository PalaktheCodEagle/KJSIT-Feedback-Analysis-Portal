...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark" style="color:#001C30 !important; font-weight:bold">Dashboard - Employee Feedback System</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
echo mysqli_num_rows($qsql);
?></h3>
                            <p style="color:white">Number of Employee's</p>
                        </div>
                        <!-- <div class="icon">
                            <i class="fa fa-eye"></i>
                        </div> -->
                        <a href="viewemployee.php" class="small-box-footer" style="color: white !important">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
