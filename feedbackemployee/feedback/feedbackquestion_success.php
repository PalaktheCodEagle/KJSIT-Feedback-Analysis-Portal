...
if (isset($_GET['feedbacktopicid'])) {
    ...
    //######
    $sqlemployee = "SELECT * FROM employee WHERE employeeid='$_GET[employeeid]'";
        ...
        <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php $sidemenu;?> Employee Detail</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rsemployee['employeename']; ?></td>
                                </tr>
                                <!-- <tr>
                                    <th>Roll no. - :</th>
                                    <td><?php echo $rsemployee['rollno']; ?></td>
                                </tr> -->
                                <tr>
                                    <th>Organisation Name:</th>
                                    <td><?php
$sqlcourse = "SELECT * FROM employee where orgname='$rsemployee[orgname]'";
$qsqlcourse = mysqli_query($con, $sqlcourse);
$rscourse = mysqli_fetch_array($qsqlcourse);
echo $rscourse['orgname'];?>
                                        (<?php echo $rsemployee['designation']; ?>)
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php
$sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_GET[feedbacktopicid]' AND employeeid='$_GET[employeeid]' and selectedanswer != ''";
$qsqlqz = mysqli_query($con, $sqlqz);
