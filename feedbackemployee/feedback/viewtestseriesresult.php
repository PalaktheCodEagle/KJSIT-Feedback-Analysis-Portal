            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
$sql = "SELECT * FROM testseries_result WHERE testseriestopicid='$_GET[testseriestopicid]' GROUP BY testseriestopicid,employeeid";
...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    $sqlqz = "SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND employeeid='$rs[employeeid]' and selectedanswer = correctanswer ";
    ...
    $sqltestseries_result = "SELECT * FROM testseries_result WHERE testseriestopicid='$rs[testseriestopicid]' AND employeeid='$rs[employeeid]'";
