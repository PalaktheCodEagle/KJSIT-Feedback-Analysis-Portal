            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
$sql = "SELECT * FROM quiz_result GROUP BY peersid";
...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    $sqlqz = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND peersid='$rs[peersid]' and selectedanswer = correctanswer ";
    ...
    $sqlquiz_result = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND peersid='$rs[peersid]'";
    ...
    echo "<tr>
				<td>";
    ?>
                            <b><?php echo $rspeers['peersname']; ?></b><br><b>Email - </b>
                            <?php echo $rspeers['email_id']; ?>
                            <?php
echo "</td>
				<td>";
    ?>
                            <?php echo $rspeers['peersclass']; ?>
...
echo "</td>
    ...
    echo "<td><a href='quiz_result.php?quiztopicid=$rs[quiztopicid]&peersid=$rs[peersid]' class='btn btn-info'>View</a> </td>";
    echo "</tr>";
}
?>
                        </tbody>
