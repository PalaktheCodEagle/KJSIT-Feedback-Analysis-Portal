...
if (isset($_POST['submit'])) {
    $sql = "UPDATE peers SET password='$_POST[npassword]' WHERE peersid='$_SESSION[peersid]' and password='$_POST[opassword]'";
    $qsql = mysqli_query($con, $sql);
    echo mysqli_error($con);
    if (mysqli_affected_rows($con) == 1) {
        echo "<script>alert('peers password Updated successfully...');</script>";
        echo "<script>window.location='peerschangepassword.php';</script>";
    } else {
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">peers Password</h3>
                </div>
                <div class="card-body">
