...
?>
                        ...
                        <?php
// $sql2 = "SELECT DISTINCT(section) FROM `peers` WHERE status='Active' and LENGTH(section) = 1 order by section ASC";
// $qsql = mysqli_query($con, $sql2);
// echo mysqli_error($con);
// while ($rs = mysqli_fetch_array($qsql)) {
...
?>
                        ...
                        <!-- <div class="form-group col-md-4">
							...
							<select class="form-control" name="peers_id" id="peers_id">
								<option value="">Select peers</option>-->
                        <?php
// $sql = "SELECT * FROM peers where peers_status='Active'";
// $qsql = mysqli_query($con, $sql);
// echo mysqli_error($con);
// while ($rs = mysqli_fetch_array($qsql)) {
//     if ($rs['peers_id'] == $rsedit['peers_id']) {
//         echo "<option value='" . $rs['peers_id'] . "' selected>" . $rs['peers_name'] . " - " . $rs['peers_designation'] . "</option>";
//     } else {
//         echo "<option value='" . $rs['peers_id'] . "'>" . $rs['peers_name'] . " - " . $rs['peers_designation'] . "</option>";
//     }
// }
?>
                        <!--</select>
							<span id="peersError" class="error" style="display: none;"></span>
						</div> -->
                        <!-- <div class="form-group col-md-6">
...
// document.getElementById('peersError').textContent = '';
// document.getElementById('peersError').style.display = 'none';
...
// document.getElementById('peers_id').addEventListener('change', validatepeers);
...
function confirmvalidation1() {
    ...
    //     isValid = false;
    // }
    // else if (!document.getElementById('peers_id').value.match(phoneRegexMax10Degit)) {
    // 	fieldValidation1();
    // 	document.getElementById('peers_id').focus();
    // 	document.getElementById('peers_id').scrollIntoView({
    // 		behavior: 'smooth'
    // 	});
    // 	isValid = false;
    // }
...
// 	if (document.getElementById('peers_id').value === '') {
// 		document.getElementById('peersError').textContent = 'Section should not be empty';
// 		document.getElementById('peersError').style.display = 'block';
// 	} else {
// 		document.getElementById('peersError').textContent = '';
// 		document.getElementById('peersError').style.display = 'none';
// 	}
