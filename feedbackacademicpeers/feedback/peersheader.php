...
error_reporting(0);
if (!isset($_SESSION['adminid']) && !isset($_SESSION['peersid'])) {
...
if (isset($_SESSION['peersid'])) {
    $sqlpeers = "SELECT * FROM peers WHERE peersid='$_SESSION[peersid]'";
...
<head>
    ...
    <title>Peers Panel - peers Feedback System..</title>
...
if (isset($_SESSION['peersid'])) {
    ?>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="peersprofile.php" class="dropdown-item">
                            <i class="fas fa-address-book"></i> My Profile
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="peerschangepassword.php" class="dropdown-item">
                            <i class="fas fa fa-unlock-alt"></i> Change Password
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="peerslogout.php" class="dropdown-item">
