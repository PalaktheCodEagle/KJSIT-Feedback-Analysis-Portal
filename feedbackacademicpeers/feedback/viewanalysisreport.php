    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               <br /> with font-awesome or any other icon font library -->
                  ...
                  <a href="peers.php" class="nav-link">
                    ...
                    <p>Add peers</p>
                                ...
                                <li class="nav-item">
                                    <a href="viewpeers.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View peers</p>
                                    </a>
                                </li>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="peers1.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add peers</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="viewpeers1.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>View peers</p>
                  </a>
                </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form method="post" action="">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <!-- <tbody>
                  <tr>
                    <td>peers Feedback on Curriculum Overall</td>
                  ...
                  <tr>
                    <td>peers Feedback on Curriculum Department wise</td>
                  ...
                  <tr>
                    <td>peers Satisfaction Survey (SSS)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- Comps (To be filled by LY peerss)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- IT (To be filled by LY peerss)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- ETRX (To be filled by LY peerss)</td>
