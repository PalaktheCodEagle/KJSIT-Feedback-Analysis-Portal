...
<body>
    ...
    <div class="bg">
        ...
        <div class="card-deck">
            ...
            <div class="card">
                <br>
                <h5 class="card-title">peers Login</h5>
                <br>
                <form action="peerslogin.php" method="post">
                    <img class="card-img-top" src="images/peers.png" alt="Card image cap"
  ...
  <br>
    ...
    <img class="card-img-top" src="images/peers.png" alt="Card image cap" style="height:125px; width:130px">
    <div class="card-body">
     <div class="social-auth-links text-center mb-3">
		<input type="submit" class="btn btn-block btn-primary"
		value=" Login " name="btnlink">
