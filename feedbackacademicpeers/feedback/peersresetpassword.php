...
if (isset($_POST['btnsubmit'])) {
    $sql = "UPDATE peers SET password='$_POST[npassword]' WHERE peersid='$_GET[id]'";
    $qsql = mysqli_query($con, $sql);
    echo mysqli_error($con);
    if (mysqli_affected_rows($con) >= 1) {
        echo "<script>alert('Password updated successfully...');</script>";
        echo "<script>window.location='peerslogin.php';</script>";
    }
}
//###
?>
...
<head>
    ...
    <title>peers Feedback System - peers Reset Password Window</title>
            ...
            <div class="container">
                ...
                <div class="forms">
                    <div class="form login">
                        ...
                        <form action="" method="post" id="frmpeersresetpassword" onsubmit="return validateform()">
