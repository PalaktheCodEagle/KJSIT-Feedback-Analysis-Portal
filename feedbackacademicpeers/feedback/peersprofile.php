...
if (isset($_POST['submit'])) {
    $sql = "UPDATE peers SET peersname='" . $_POST['peersname'] . "',email_id='" . $_POST['email_id'] . "',`teachingexp`='" . $_POST['teachingexp'] . "',`peers_no`='" . $_POST['peers_no'] . "',`colname`='" . $_POST['colname'] . "',`dateofbirth`='" . $_POST['dateofbirth'] . "',`academicyear`='" . $_POST['academicyear'] . "',`research`='" . $_POST['research'] . "',`subtaught`='" . $_POST['subtaught'] . "',`designation`='" . $_POST['designation'] . "',`course_id`='" . $_POST['course_id'] . "' WHERE peersid='$_SESSION[peersid]'";
...
if (isset($_SESSION['peersid'])) {
    ...
    $sqledit = "SELECT * FROM peers WHERE peersid='$_SESSION[peersid]'";
...
<div class="content-wrapper">
        ...
        <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> Academic Peers Entry</h3>
                </div>
                <div class="card-body">
    ...
    echo $rsedit['dateofbirth'];
                    ...
                    <div class="row">
                        <div class="col-md-3"> Academic Peer's Contact No.</div>
                        <div class="col-md-5">
    ...
    echo $rsedit['colname'];
                        ...
                        <div class="col-md-4"><span class="errmsg flash" id="errcolname"
                                style="color: red;"></span></div>
                    </div><br>
                    <div class="row">
    ...
    echo $rsedit['designation'];
                     ...
                     <div class="row">
                        <div class="col-md-3">Subject Taught</div>
                        <div class="col-md-5">
    ...
    echo $rsedit['research'];
                        ...
                        <div class="col-md-4"><span class="errmsg flash" id="errresearch"
                                style="color: red;"></span></div>
                    </div><br>
