...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO peers SET peersname='" . $_POST['peersname'] . "',email_id='" . $_POST['email_id'] . "',peers_no='" . $_POST['peers_no'] . "',dateofbirth='" . $_POST['dateofbirth'] . "',designation='" . $_POST['designation'] . "',colname='" . $_POST['colname'] . "',research='" . $_POST['research'] . "',password='" . $_POST['password'] . "',teachingexp='" . $_POST['teachingexp'] . "',subtaught='" . $_POST['subtaught'] . "',status='Inactive' ";
    ...
    if (mysqli_affected_rows($con) == 1) {
        //     $message = "Welcome $_POST[peersname],<br>
        // Click the following link to verify your email: <a href='$url/feedbackpeers/feedback/peersemailverify.php?code=$verificationCode'>Verify Email</a>";

        $message = "Dear $_POST[peersname],<br><br>
...
<br><br>
<a href='$url/feedbackacademicpeers/feedback/peersemailverify.php?code=$verificationCode'>Verify Account</a>
<br><br>
...
KJSIT Stakeholders Feedback Analysis Team.";
        ...
        sendmail($_POST['email_id'], $_POST['peersname'], "Account Verification for KJSIT Stakeholders Feedback System", $message);

        $sql = "UPDATE `peers` SET verification_code='" . $verificationCode . "' WHERE `email_id`='" . $_POST['email_id'] . "'";
        mysqli_query($con, $sql);

        echo "<script>alert('Please check your registed email for to verify your account in the peers Feedback Portal. Thank you.');</script>";
...
<head>
    ...
    <title>Peers Feedback - Peers Login Window</title>
...
<body>
    ...
    <div class="main">
        ...
        <br>
        <!-- peers Registration Window -->

        <div class="heading">

            <h1 style="font-weight: bold; margin-bottom:0px ">Peers Registration</h1>
        </div>
                ...
                <div class="content">
                    <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="peersname" id="peersname" required
                                placeholder="Enter Your Full Name" value="<?php if (isset($rsedit['peersname'])) {
    echo $rsedit['peersname'];
}?>">
                            <span id="peersnameError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <!-- <div class="col-12">
...
?>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="email_id"
                                placeholder="Enter Your Somaiya Email Id" id="email_id" required value="<?php if (isset($rsedit['email_id'])) {
    echo $rsedit['email_id'];
                        ...
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">peers's Contact</label>
                            <input type="text" class="form-control" required name="peers_no" maxlength="10"
                                placeholder="peers Contact" id="peers_no" value="<?php if (isset($rsedit['peers_no'])) {
    echo $rsedit['peers_no'];
}?>">
                            <span id="peerssnoError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
                            <label for="inputEmail4" class="form-label">College name</label>
                            <input type="text" class="form-control" name="colname"
                                placeholder="Enter Your Somaiya Email Id" id="colname" required value="<?php if (isset($rsedit['colname'])) {
    echo $rsedit['colname'];
}?>">
                            <span id="colnameError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="designation" class="form-label">Designation</label>
                            <input type="text" class="form-control" name="designation" placeholder="Enter Designation"
                                id="designation" required value="<?php if (isset($rsedit['designation'])) {
    echo $rsedit['designation'];
}?>">
                            <span id="designationError" class="error" style="display: none;"></span>

                        </div><br>
                        <div class="col-md-12">
                            <label for="teachingexp" class="form-label">Number of Years of Experience in
                                Teaching</label>
                            <input type="text" class="form-control" name="teachingexp" maxlength="3"
                                placeholder="Enter Number of Years of Experience in Teaching" id="teachingexp" required
                                value="<?php if (isset($rsedit['teachingexp'])) {
    echo $rsedit['teachingexp'];
}?>">
                            <span id="teachingexpError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="industryexp" class="form-label">Area of research</label>
                            <input type="text" class="form-control" name="research"
                                placeholder="Number of Years of Experience in Industry" id="research"
                                autocomplete="Enter Area of research" value="<?php if (isset($rsedit['research'])) {
    echo $rsedit['research'];
}?>">
                            <span id="industryexpError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="subtaught" class="form-label">Subject Taught</label>
                            <input type="text" class="form-control" name="subtaught" placeholder="Subject Taught"
                                id="subtaught" autocomplete="Enter Subjecy Taught" value="<?php if (isset($rsedit['subtaught'])) {
    echo $rsedit['subtaught'];
}?>">
                            <span id="subtaughtError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="inputDOB" class="form-label">Date Of Birth</label>
                            <input type="date" class="form-control" name="dateofbirth" id="dateofbirth" required value="<?php if (isset($rsedit['dateofbirth'])) {
...
?>
    ...
    document.getElementById('peersnameError').textContent = '';
    document.getElementById('peersnameError').style.display = 'none';
    ...
    document.getElementById('peerssnoError').textContent = '';
    document.getElementById('peerssnoError').style.display = 'none';
    ...
    document.getElementById('teachingexpError').textContent = '';
    document.getElementById('teachingexpError').style.display = 'none';
    document.getElementById('industryexpError').textContent = '';
    document.getElementById('industryexpError').style.display = 'none';
    ...
    function confirmvalidation() {
        ...
        if (document.getElementById('peersname').value === '') {
            fieldValidation();
            document.getElementById('peersname').focus();
            document.getElementById('peersname').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        }
        ...
        //     isValid = false;
        // }
        else if (document.getElementById('peers_no').value === '') {
            fieldValidation();
            document.getElementById('peers_no').focus();
            document.getElementById('peers_no').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (!document.getElementById('peers_no').value.match(phoneRegexOnlyNo)) {
            fieldValidation();
            document.getElementById('peers_no').focus();
            document.getElementById('peers_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (!document.getElementById('peers_no').value.match(phoneRegexMax10Degit)) {
            fieldValidation();
            document.getElementById('peers_no').focus();
            document.getElementById('peers_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (document.getElementById('teachingexp').value === '') {
            fieldValidation();
            document.getElementById('teachingexp').focus();
            document.getElementById('teachingexp').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (document.getElementById('industryexp').value === '') {
            fieldValidation();
            document.getElementById('industryexp').focus();
            document.getElementById('industryexp').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        }
    ...
    function validatepeersname() {
        if (document.getElementById('peersname').value === '') {
            document.getElementById('peersnameError').textContent = 'Original Name should not be empty.';
            document.getElementById('peersnameError').style.display = 'block';
        } else {
            document.getElementById('peersnameError').textContent = '';
            document.getElementById('peersnameError').style.display = 'none';
        }
    ...
    function validatepeersNo() {
        if (document.getElementById('peers_no').value === '') {
            document.getElementById('peerssnoError').textContent = 'peers No should not be empty';
            document.getElementById('peerssnoError').style.display = 'block';
        } else if (!document.getElementById('peers_no').value.match(phoneRegexOnlyNo)) {
            document.getElementById('peerssnoError').textContent =
                'Please enter a valid phone number (digits and + only).';
            document.getElementById('peerssnoError').style.display = 'block';
        } else if (!document.getElementById('peers_no').value.match(phoneRegexMax10Degit)) {
            document.getElementById('peerssnoError').textContent = 'Please enter a valid 10-digit phone number.';
            document.getElementById('peerssnoError').style.display = 'block';
        } else {
            document.getElementById('peerssnoError').textContent = '';
            document.getElementById('peerssnoError').style.display = 'none';
    ...
    function validateteachingexp() {
        if (document.getElementById('teachingexp').value === '') {
            document.getElementById('teachingexpError').textContent = 'Teaching Experience should not be empty';
            document.getElementById('teachingexpError').style.display = 'block';
        } else {
            document.getElementById('teachingexpError').textContent = '';
            document.getElementById('teachingexpError').style.display = 'none';
        }
    ...
    function validateindustryexp() {
        if (document.getElementById('industryexp').value === '') {
            document.getElementById('industryexpError').textContent = 'Area Of Research should not be empty';
            document.getElementById('industryexpError').style.display = 'block';
        } else {
            document.getElementById('industryexpError').textContent = '';
            document.getElementById('industryexpError').style.display = 'none';
        }
    ...
    document.getElementById('peersname').addEventListener('change', validatepeersname);
    ...
    document.getElementById('peers_no').addEventListener('change', validatepeersNo);
    ...
    document.getElementById('teachingexp').addEventListener('change', validateteachingexp);
    document.getElementById('industryexp').addEventListener('change', validateindustryexp);
