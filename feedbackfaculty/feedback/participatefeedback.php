...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    echo "<td>";
    $sqlfeedbacktest = "select * from feedbackquestion_result WHERE feedbacktopicid='$rs[feedbacktopicid]' AND facultyid='$_SESSION[facultyid]'";
    $qsqlfeedbacktest = mysqli_query($con, $sqlfeedbacktest);
    if (mysqli_num_rows($qsqlfeedbacktest) >= 1) {
        echo "<a href='feedbackquestion_success.php?feedbacktopicid=$rs[0]&facultyid=$_SESSION[facultyid]' class='btn btn-success'  >View Entries</a>";
    } else {
