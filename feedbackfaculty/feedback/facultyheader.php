...
error_reporting(0);
if (!isset($_SESSION['adminid']) && !isset($_SESSION['facultyid'])) {
...
if (isset($_SESSION['facultyid'])) {
    $sqlfaculty = "SELECT * FROM faculty WHERE facultyid='$_SESSION[facultyid]'";
...
<head>
    ...
    <title>Faculty Panel - Faculty Feedback System..</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" style="color:white"><i class="fas fa-bars"
...
if (isset($_SESSION['facultyid'])) {
    ?>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="facultyprofile.php" class="dropdown-item">
                            <i class="fas fa-address-book"></i> My Profile
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="facultychangepassword.php" class="dropdown-item">
                            <i class="fas fa fa-unlock-alt"></i> Change Password
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="facultylogout.php" class="dropdown-item">
