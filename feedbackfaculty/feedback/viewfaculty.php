...
if (isset($_GET['delid'])) {
    ...
    $sqledit = "SELECT * FROM faculty WHERE facultyid='" . $_GET['delid'] . "'";
    $qsqledit = mysqli_query($con, $sqledit);
    echo mysqli_error($con);
    $rsedit = mysqli_fetch_array($qsqledit);
    //Step 2 : Select statement ends here
    //################################
    $log_message = "Faculty Account $rsedit[facultyname] deleted...";
    $sql = "DELETE FROM `faculty` where facultyid ='" . $_GET['delid'] . "' ";
        ...
        <form method="post" action="">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">View Faculty Profile</h3>
                </div>
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
$sql = "SELECT ss.* FROM faculty ss WHERE ss.status != '' ";
...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    echo "<tr>
				...
				<td>$rs[status]</td>
				<td style='width: 75px;'><a href='faculty.php?editid=$rs[0]' class='btn btn-info' style='width: 75px;'>Edit</a>  
                </td><td>
                <a href='viewfaculty.php?delid=$rs[0]' onclick='return validatedel()'  class='btn btn-danger' style='width: 75px;' >Delete</a></td>
			</tr>";
}
?>
                        </tbody>
