...
if (isset($_GET['feedbacktopicid'])) {
    ...
    //######
    $sqlfaculty = "SELECT * FROM faculty WHERE facultyid='$_GET[facultyid]'";
        ...
        <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><?php $sidemenu;?> Faculty Detail</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th style="width: 250px;">Faculty Name:</th>
                                    <td><?php echo $rsfaculty['facultyname']; ?></td>
                                </tr>
                                <!-- <tr>
                                    <th>Roll no. - :</th>
                                    <td><?php echo $rsfaculty['rollno']; ?></td>
                                </tr> -->
                                <tr>
                                    <th>Designation</th>
                                    <td><?php
$sqlcourse = "SELECT * FROM faculty where designation='$rsfaculty[designation]'";
$qsqlcourse = mysqli_query($con, $sqlcourse);
$rscourse = mysqli_fetch_array($qsqlcourse);
echo $rscourse['designation'];?>
                                        <!-- (<?php echo $rsfaculty['section']; ?>) -->
                                    </td>
                                </tr>
                            </table>
                        </div>
...
if ($rsedit['course_id'] != 0) {
        ?>
                                <tr>
                                    <th>Course:</th>
                                    <td><?php
$sqlcourse = "SELECT * FROM course where course_id='$rsfaculty[course_id]'";
        $qsqlcourse = mysqli_query($con, $sqlcourse);
        $rscourse = mysqli_fetch_array($qsqlcourse);
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php
$sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_GET[feedbacktopicid]' AND facultyid='$_GET[facultyid]' and selectedanswer != ''";
$qsqlqz = mysqli_query($con, $sqlqz);
