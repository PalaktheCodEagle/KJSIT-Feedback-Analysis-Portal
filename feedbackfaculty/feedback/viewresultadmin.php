            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
$sql = "SELECT * FROM quiz_result GROUP BY facultyid";
...
while ($rs = mysqli_fetch_array($qsql)) {
    ...
    $sqlqz = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND facultyid='$rs[facultyid]' and selectedanswer = correctanswer ";
    ...
    $sqlquiz_result = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND facultyid='$rs[facultyid]'";
    ...
    echo "<tr>
				<td>";
    ?>
                            <b><?php echo $rsfaculty['facultyname']; ?></b><br><b>Email - </b>
                            <?php echo $rsfaculty['email_id']; ?>
                            <?php
echo "</td>
				<td>";
    ?>
                            <?php echo $rsfaculty['facultyclass']; ?>
...
echo "</td>
    ...
    echo "<td><a href='quiz_result.php?quiztopicid=$rs[quiztopicid]&facultyid=$rs[facultyid]' class='btn btn-info'>View</a> </td>";
    echo "</tr>";
}
?>
                        </tbody>
