...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO faculty SET facultyname='" . $_POST['facultyname'] . "',email_id='" . $_POST['email_id'] . "',faculty_no='" . $_POST['faculty_no'] . "',dateofbirth='" . $_POST['dateofbirth'] . "',password='" . $_POST['password'] . "',course_id='" . $_POST['course'] . "',teachingexp='" . $_POST['teachingexp'] . "',industryexp='" . $_POST['industryexp'] . "',designation='" . $_POST['designation'] . "',status='Inactive' ";
    ...
    //     $message = "Welcome $_POST[facultyname],<br>
    // Click the following link to verify your email: <a href='$url/feedbackfaculty/feedback/facultyemailverify.php?code=$verificationCode'>Verify Email</a>";

    $message="Dear $_POST[facultyname],<br><br>
...
<br><br>
<a href='$url/feedbackfaculty/feedback/facultyemailverify.php?code=$verificationCode'>Verify Account</a>
<br><br>
...
KJSIT Stakeholders Feedback Analysis Team.";
    ...
    include "phpmailer.php";
        sendmail($_POST['email_id'], $_POST['facultyname'], "Account Verification for KJSIT Stakeholders Feedback System", $message);

        $sql = "UPDATE `faculty` SET verification_code='" . $verificationCode . "' WHERE `email_id`='" . $_POST['email_id'] . "'";
        mysqli_query($con, $sql);

        echo "<script>alert('Please check your registed email for to verify your account in the Faculty Feedback Portal. Thank you.');</script>";
...
<head>
    ...
    <title>Faculty Feedback - Faculty Login Window</title>
...
<body>
    ...
    <div class="main">
        ...
        <br>
        <!-- faculty Registration Window -->

        <div class="heading">

            <h1 style="font-weight: bold; margin-bottom:0px ">Faculty Registration</h1>
        </div>
                    ...
                    <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="facultyname" id="facultyname" required
                                placeholder="Enter Your Full Name" value="<?php if (isset($rsedit['facultyname'])) {
    echo $rsedit['facultyname'];
}?>">
                            <span id="facultynameError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <!-- <div class="col-12">
...
?>
                        ...
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">Faculty's Contact</label>
                            <input type="text" class="form-control" required name="faculty_no" maxlength="10"
                                placeholder="faculty Contact" id="faculty_no" value="<?php if (isset($rsedit['faculty_no'])) {
    echo $rsedit['faculty_no'];
}?>">
                            <span id="facultysnoError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">Password</label>
                            <input type="password" class="form-control" name="password"
                                placeholder="Enter Your Password" id="password" required autocomplete="new-password" value="<?php if (isset($rsedit['password'])) {
    ...
    echo $rsedit['password'];
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="teachingexp" maxlength="3"
                                placeholder="Enter Number of Years of Experience in Teaching" id="teachingexp" required value="<?php if (isset($rsedit['teachingexp'])) {
    echo $rsedit['teachingexp'];
}?>">
                            <span id="teachingexpError" class="error" style="display: none;"></span>
                        </div><br>
                        <div class="col-md-12">
                            <label for="industryexp" class="form-label">Number of Years of Experience in
                                Industry</label>
                            <input type="text" class="form-control" name="industryexp" maxlength="3"
                                placeholder="Number of Years of Experience in Industry" id="industryexp"
                                autocomplete="Enter Number of Years of Experience in Industry" value="<?php if (isset($rsedit['industryexp'])) {
...
?>
    ...
    document.getElementById('facultynameError').textContent = '';
    ...
    document.getElementById('facultysnoError').textContent = '';
    document.getElementById('facultysnoError').style.display = 'none';
    ...
    function confirmvalidation() {
        ...
        if (document.getElementById('facultyname').value === '') {
            ...
            document.getElementById('facultyname').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        }
        ...
        //     isValid = false;
        // }
        else if (document.getElementById('faculty_no').value === '') {
            fieldValidation();
            document.getElementById('faculty_no').focus();
            document.getElementById('faculty_no').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (!document.getElementById('faculty_no').value.match(phoneRegexOnlyNo)) {
            fieldValidation();
            document.getElementById('faculty_no').focus();
            document.getElementById('faculty_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (!document.getElementById('faculty_no').value.match(phoneRegexMax10Degit)) {
            fieldValidation();
            document.getElementById('faculty_no').focus();
            document.getElementById('faculty_no').scrollIntoView({
                behavior: 'smooth'
    ...
    function validatefacultyname() {
        if (document.getElementById('facultyname').value === '') {
            document.getElementById('facultynameError').textContent = 'Original Name should not be empty.';
    ...
    function validatefacultyNo() {
        if (document.getElementById('faculty_no').value === '') {
            document.getElementById('facultysnoError').textContent = 'faculty No should not be empty';
            document.getElementById('facultysnoError').style.display = 'block';
        } else if (!document.getElementById('faculty_no').value.match(phoneRegexOnlyNo)) {
            document.getElementById('facultysnoError').textContent =
                'Please enter a valid phone number (digits and + only).';
            document.getElementById('facultysnoError').style.display = 'block';
        } else if (!document.getElementById('faculty_no').value.match(phoneRegexMax10Degit)) {
            document.getElementById('facultysnoError').textContent = 'Please enter a valid 10-digit phone number.';
            document.getElementById('facultysnoError').style.display = 'block';
        } else {
            document.getElementById('facultysnoError').textContent = '';
            document.getElementById('facultysnoError').style.display = 'none';
    ...
    function validateindustryexp() {
        if (document.getElementById('industryexp').value === '') {
            document.getElementById('industryexpError').textContent = 'Industry Experience should not be empty';
    ...
    document.getElementById('facultyname').addEventListener('change', validatefacultyname);
    ...
    document.getElementById('faculty_no').addEventListener('change', validatefacultyNo);
    ...
    document.getElementById('teachexp').addEventListener('change', validateteachingexp);
