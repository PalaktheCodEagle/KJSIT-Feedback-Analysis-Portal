...
?>
<?php
$sqlqz ="SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$_SESSION[date]' AND facultyid='$_SESSION[facultyid]' and selectedanswer != ''";
