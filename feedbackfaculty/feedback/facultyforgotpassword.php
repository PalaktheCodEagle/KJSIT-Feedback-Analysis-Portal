...
if (isset($_POST['btnsubmit'])) {
    $sql = "SELECT * FROM faculty WHERE email_id='$_POST[email]' and status='Active'";
    ...
    if (mysqli_num_rows($qsql) >= 1) {
        ...
        // $message = "Hello $rspro[facultyname],<br>
		// You have sent request to recover password. Kindly press below link to reset password...<br><br>
		// Visit Link - <b><a href='$url/feedbackfaculty/feedback/facultyresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b><br>
		// ";
        $message = "Dear $rspro[facultyname],<br>
            <br>
            ...
            <br><br>
            Reset Password:<b><a href='$url/feedbackfaculty/feedback/facultyresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b>
            <br><br>
        ...
        sendmail($rspro['email_id'], $rspro['facultyname'], "Password Recovery Mail", $message);
...
<head>
    ...
    <title>Faculty Feedback System - Faculty Forgot Password Window</title>
