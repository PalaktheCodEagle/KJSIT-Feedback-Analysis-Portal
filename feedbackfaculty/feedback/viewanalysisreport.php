    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="faculty1.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Faculty</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="viewfaculty1.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>View Faculty</p>
                  </a>
                </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form method="post" action="">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <!-- <tbody>
                  <tr>
                    <td>faculty Feedback on Curriculum Overall</td>
                  ...
                  <tr>
                    <td>faculty Feedback on Curriculum Department wise</td>
                  ...
                  <tr>
                    <td>faculty Satisfaction Survey (SSS)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- Comps (To be filled by LY facultys)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- IT (To be filled by LY facultys)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- ETRX (To be filled by LY facultys)</td>
