...
if (isset($_POST['submit'])) {
    $sql = "UPDATE faculty SET facultyname='" . $_POST['facultyname'] . "',email_id='" . $_POST['email_id'] . "',`designation`='" . $_POST['designation'] . "',`faculty_no`='" . $_POST['faculty_no'] . "',`academicyear`='" . $_POST['academicyear'] . "',`dateofbirth`='" . $_POST['dateofbirth'] . "',`industryexp`='" . $_POST['industryexp'] . "',`teachingexp`='" . $_POST['teachingexp'] . "',`course_id`='" . $_POST['course_id'] . "' WHERE facultyid='$_SESSION[facultyid]'";
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-3">Faculty's Contact No.</div>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="faculty_no" maxlength="10" id="faculty_no"
