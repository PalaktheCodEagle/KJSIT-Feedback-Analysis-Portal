...
error_reporting(0);
if (!isset($_SESSION['adminid']) && !isset($_SESSION['alumniid'])) {
...
if (isset($_SESSION['alumniid'])) {
    $sqlalumni = "SELECT * FROM alumni WHERE alumniid='$_SESSION[alumniid]'";
...
<head>
    ...
    <title>Alumni Panel - Alumni Feedback System..</title>
...
if (isset($_SESSION['alumniid'])) {
    ?>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="alumniprofile.php" class="dropdown-item">
                            <i class="fas fa-address-book"></i> My Profile
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="alumnichangepassword.php" class="dropdown-item">
                            <i class="fas fa fa-unlock-alt"></i> Change Password
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="alumnilogout.php" class="dropdown-item">
