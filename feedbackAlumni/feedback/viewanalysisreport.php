               ...
               <br /> with font-awesome or any other icon font library -->
                ...
                <a href="alumni.php" class="nav-link">
                  ...
                  <p>Add  alumni</p>
                                ...
                                <li class="nav-item">
                                    <a href="viewalumni.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Alumni</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form method="post" action="">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="myTable" class="table table-striped table-bordered">
                                ...
                                <!-- <tbody>
                  <tr>
                    <td>alumni Feedback on Curriculum Overall</td>
                  ...
                  <tr>
                    <td>alumni Feedback on Curriculum Department wise</td>
                  ...
                  <tr>
                    <td>alumni Satisfaction Survey (SSS)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- Comps (To be filled by LY alumnis)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- IT (To be filled by LY alumnis)</td>
                  ...
                  <tr>
                    <td>Program Exit Survey- ETRX (To be filled by LY alumnis)</td>
