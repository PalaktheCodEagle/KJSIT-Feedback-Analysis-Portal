...
if (isset($_POST['submit'])) {
	...
	if (isset($_GET['feedbacktopicid'])) {
		...
		$sql = $sql . ", feedbacktopic_detail='$feedback_detail', course_id='$_POST[course_id]',year_id='$_POST[courseyear]'";
		...
		$sql = "INSERT INTO feedbacktopic(feedback_topic, feedbacktopic_date, feedback_icon, feedbacktopic_detail, feedbacktopic_status,course_id,year_id) values('$_POST[feedback_topic]','$dttim','$feedback_icon','$feedback_detail','Approved','$_POST[course_id]','$_POST[courseyear]')";
			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						...
						<?php
						// $sql2 = "SELECT DISTINCT(section) FROM `alumni` WHERE status='Active' and LENGTH(section) = 1 order by section ASC";
