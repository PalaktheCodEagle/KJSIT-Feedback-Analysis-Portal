...
if (isset($_POST['btnsubmit'])) {
    $sql = "SELECT * FROM alumni WHERE email_id='$_POST[email]' and status='Active'";
    ...
    if (mysqli_num_rows($qsql) >= 1) {
        ...
        // $message = "Hello $rspro[alumniname],<br>
        // You have sent request to recover password. Kindly press below link to reset password...<br><br>
        // Visit Link - <b><a href='$url/alumniresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b><br>
        // ";
        //echo $rspro['rollno'];
        $message = "Dear $rspro[alumniname],<br>
        <br>
        ...
        <br><br>
        Reset Password:<b><a href='$url/feedbackAlumni/feedback/alumniresetpassword.php?resetid=$_SESSION[resetid]&id=$rspro[0]'>Click here</a></b>
        <br><br>
        ...
        sendmail($rspro['email_id'], $rspro['alumniname'], "Password Recovery Mail", $message);
...
<head>
    ...
    <title>Alumni Feedback System - Alumni Forgot Password Window</title>
