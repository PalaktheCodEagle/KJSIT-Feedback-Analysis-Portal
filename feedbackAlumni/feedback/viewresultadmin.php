            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM quiz_result GROUP BY alumniid";
                            ...
                            while ($rs = mysqli_fetch_array($qsql)) {
                                ...
                                $sqlqz = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND alumniid='$rs[alumniid]' and selectedanswer = correctanswer ";
                                ...
                                $sqlquiz_result = "SELECT * FROM quiz_result WHERE quiztopicid='$rs[quiztopicid]' AND alumniid='$rs[alumniid]'";
				...
				<td>";
                            ?>
                            <b><?php echo $rsalumni['alumniname']; ?></b><br><b>Email - </b>
				...
				<td>" . date("d-M-Y", strtotime($rs['date'])) . "</td>";
                                ...
                                echo "<td><a href='quiz_result.php?quiztopicid=$rs[quiztopicid]&alumniid=$rs[alumniid]' class='btn btn-info'>View</a> </td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
