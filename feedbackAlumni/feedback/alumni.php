...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['editid'])) {
        $sql = "UPDATE alumni SET alumniname='" . $_POST['alumniname'] . "',years_id='" . $_POST['years_id'] . "',email_id='" . $_POST['email_id'] . "',dateofbirth='" . $_POST['dateofbirth'] . "',alumni_no='" . $_POST['alumni_no'] . "',`course_id`='" . $_POST['alumniclass'] . "',status='" . $_POST['status'] . "' WHERE alumniid='" . $_GET['editid'] . "'";
    ...
    // else
    // {
    //     $sql ="INSERT INTO alumni SET alumniname='".$_POST['alumniname']."',`dateofbirth`='".$_POST['dateofbirth']."',`password`='".$_POST['password']."',`course_id`='".$_POST['alumniclass']."',`section`='".$_POST['section']."',status='".$_POST['status']."'   ";
    //     $qsql = mysqli_query($con,$sql);
    //         echo mysqli_error($con);
    //     if(mysqli_affected_rows($con) ==1)
    //     {
    //         $insid=mysqli_insert_id($con);
    //         echo "<script>alert('alumni Profile inserted successfully...');</script>";
...
<div class="content-wrapper">
    ...
    echo $rsedit['email_id'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="alumni_no" maxlength="10" id="alumni_no"
...
function confirmvalidation() {
    ...
    if (document.getElementById("alumniclass").value == "") {
