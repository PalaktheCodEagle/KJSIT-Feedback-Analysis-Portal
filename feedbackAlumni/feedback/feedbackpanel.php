...
if (!isset($_SESSION['date'])) {
	...
	$sql1 = "select * from  feedbackquestion_result where feedbacktopicid = '$_SESSION[feedbacktopicid]' and alumniid = '$_SESSION[alumniid]'";
	if ($result1 = mysqli_query($con, $sql1)) {
		$rowcount = mysqli_num_rows($result1);
	}
	if ($rowcount > 0) {
		echo "<script>window.location='feedbackquestion_success.php?feedbacktopicid=$_SESSION[feedbacktopicid]&alumniid=$_SESSION[alumniid]';</script>";
	}
...
if (isset($_SESSION['feedbacktopicid'])) {
	...
	// //######
	// $sqlalumni = "SELECT * FROM alumni WHERE alumniid='$rsedit[alumniid]'";
...
if (isset($_POST['submit'])) {
	...
	while ($rs = mysqli_fetch_array($result)) {
		$rowcount = 0;
		$sql1 = "select * from  feedbackquestion_result where feedbacktopicid = '$_SESSION[feedbacktopicid]' and feedbackquestionid = '$rs[0]' and alumniid = '$_SESSION[alumniid]'";
		if ($result1 = mysqli_query($con, $sql1)) {
			$rowcount = mysqli_num_rows($result1);
		}
		...
		if ($rowcount > 0) {
			$sqlupd  = "UPDATE feedbackquestion_result SET selectedanswer='$answer' WHERE feedbacktopicid = '$_SESSION[feedbacktopicid]' and feedbackquestionid = '$rs[0]' and alumniid = '$_SESSION[alumniid]'";
		} else {
			$sqlins = "INSERT INTO feedbackquestion_result SET feedbacktopicid='$_SESSION[feedbacktopicid]', alumniid='$_SESSION[alumniid]', date='. $_SESSION[date] . ', feedbackquestionid='$rs[0]', selectedanswer='$answer'";
                                ...
                                <th>
                                    <center>
                                        ...
                                        <span id="idansweredquestions"><?php
																			...
																			$sqlqz = "SELECT *FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$date1' AND alumniid='$_SESSION[alumniid]' and selectedanswer != ''";
...
include("footer.php");
?>
<div id="idansstatus"><?php $sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$_SESSION[dttim]' AND alumniid='$_SESSION[alumniid]' and selectedanswer != ''";
						$qsqlqz  = mysqli_query($con, $sqlqz); ?><input type="hidden" name="answereedq" id="answereedq"
        value="<?php echo mysqli_num_rows($qsqlqz); ?>"><?php $sqlqz = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$_SESSION[feedbacktopicid]' AND date='$_SESSION[dttim]' AND alumniid='$_SESSION[alumniid]' and selectedanswer=''";
