    ...
    <section class="content">
        <form method="post" action="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    $sql = "SELECT * FROM `feedbacktopic` WHERE course_id in ((select course_id from alumni where alumniid = $_SESSION[alumniid]), (select course_id from course where course_title='All')) and year_id in ((select year_id from alumni where alumniid = $_SESSION[alumniid]), (select years_id from years where years_title='All'))";
		...
		<br>$rs[feedbacktopic_detail]";
                        ...
                        echo "<td>";
                        $sqlfeedbacktest = "select * from feedbackquestion_result WHERE feedbacktopicid='$rs[feedbacktopicid]' AND alumniid='$_SESSION[alumniid]'";
                        $qsqlfeedbacktest = mysqli_query($con, $sqlfeedbacktest);
                        if (mysqli_num_rows($qsqlfeedbacktest) >= 1) {
                            echo "<a href='feedbackquestion_success.php?feedbacktopicid=$rs[0]&alumniid=$_SESSION[alumniid]' class='btn btn-success'  >View Entries</a>";
                        } else {
