...
if (isset($_POST['submit'])) {
	$sql = "UPDATE alumni SET password='$_POST[npassword]' WHERE alumniid='$_SESSION[alumniid]' and password='$_POST[opassword]'";
	$qsql = mysqli_query($con, $sql);
	echo mysqli_error($con);
	if (mysqli_affected_rows($con) == 1) {
		echo "<script>alert('Alumni password Updated successfully...');</script>";
		echo "<script>window.location='alumnichangepassword.php';</script>";
	} else {
