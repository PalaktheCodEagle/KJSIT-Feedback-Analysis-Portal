...
if (isset($_POST['btnsubmit'])) {
    $sql = "UPDATE alumni SET password='$_POST[npassword]' WHERE alumniid='$_GET[id]'";
    $qsql = mysqli_query($con, $sql);
    echo mysqli_error($con);
    if (mysqli_affected_rows($con) >= 1) {
        echo "<script>alert('Password updated successfully...');</script>";
        echo "<script>window.location='alumnilogin.php';</script>";
    }
}
//###
?>
...
<head>
    ...
    <title>Alumni Feedback System - Alumni Reset Password Window</title>
            ...
            <div class="container">
                ...
                <div class="forms">
                    <div class="form login">
                        ...
                        <form action="" method="post" id="frmalumniresetpassword" onsubmit="return validateform()">
