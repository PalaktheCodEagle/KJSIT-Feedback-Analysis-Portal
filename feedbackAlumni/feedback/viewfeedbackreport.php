            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
							$sql = "SELECT * FROM feedbackquestion_result GROUP BY alumniid";
							...
							while ($rs = mysqli_fetch_array($qsql)) {
								...
								//######
								/*		
$sqlqz ="SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$rs[feedbacktopicid]' AND alumniid='$rs[alumniid]' and selectedanswer = correctanswer ";
$qsqlqz  = mysqli_query($con,$sqlqz);
echo mysqli_error($con);
$correctanswer= mysqli_num_rows($qsqlqz);
*/

								$sqlfeedbackquestion_result = "SELECT * FROM feedbackquestion_result WHERE feedbacktopicid='$rs[feedbacktopicid]' AND alumniid='$rs[alumniid]'";
				...
				<td>";
							?>
                            <b><?php echo $rsalumni['alumniname']; ?></b><br><b>Roll no. - </b>
                            <!-- <?php echo $rsalumni['rollno']; ?> -->
                            <?php
								echo "</td>
				<td>";
								?>
				...
				<td>" . date("d-M-Y", strtotime($rs['date'])) . "</td>";
								if (isset($_SESSION['adminid'])) {
									echo "<td><a href='admin_feedbackquestion_success.php?feedbacktopicid=$rs[feedbacktopicid]&alumniid=$rs[alumniid]' class='btn btn-info'>View</a> </td>";
								} else {
									echo "<td><a href='feedbackquestion_success.php?feedbacktopicid=$rs[feedbacktopicid]&alumniid=$rs[alumniid]' class='btn btn-info'>View</a> </td>";
								}
								echo "</tr>";
							}
							?>
