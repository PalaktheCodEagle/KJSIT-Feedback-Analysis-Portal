          ...
          <div class="small-box bg-warning" style="background-color:#005baa !important; box-shadow: 5px 10px #CFD2CF;">
            <div class="inner">
              <h3 style="color:white"><?php
                  ...
                  echo mysqli_num_rows($qsql);
                  ?></h3>
              <p style="color:white">Number of Alumni</p>
            </div>
            <!-- <div class="icon">
              <i class="fa fa-eye"></i>
            </div> -->
            <a href="viewalumni.php" class="small-box-footer" style="color: white !important">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
