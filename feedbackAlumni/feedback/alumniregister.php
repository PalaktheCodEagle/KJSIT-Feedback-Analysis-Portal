...
if (isset($_SESSION['alumniid'])) {
    echo "<script>window.location='alumnidashboard.php';</script>";
}
...
if (isset($_POST['submit'])) {
    $sql = "INSERT INTO alumni SET alumniname='" . $_POST['alumniname'] . "',email_id='" . $_POST['email_id'] . "',alumni_no='" . $_POST['alumni_no'] . "',dateofbirth='" . $_POST['dateofbirth'] . "',password='" . $_POST['password'] . "',course_id='" . $_POST['course'] . "',years_id='" . $_POST['courseyear'] . "',status='Inactive' ";
    ...
    if (mysqli_affected_rows($con) == 1) {
        //     $message = "Welcome $_POST[alumniname],<br>
        // Click the following link to verify your email: <a href='$url/feedbackAlumni/feedback/alumniemailverify.php?code=$verificationCode'>Verify Email</a>";
        $message = "Dear $_POST[alumniname],<br><br>
    ...
    <br><br>
    <a href='$url/feedbackAlumni/feedback/alumniemailverify.php?code=$verificationCode'>Verify Account</a>
    <br><br>
    ...
    KJSIT Stakeholders Feedback Analysis Team.";
        ...
        sendmail($_POST['email_id'], $_POST['alumniname'], "Account Verification for KJSIT Stakeholders Feedback System", $message);

        $sql = "UPDATE `alumni` SET verification_code='" . $verificationCode . "' WHERE `email_id`='" . $_POST['email_id'] . "'";
        mysqli_query($con, $sql);

        echo "<script>alert('Please check your registed email for to verify your account in the Alumni Feedback Portal. Thank you.');</script>";
        echo "<script>window.location='../../index.php';</script>";
    }
    //}
}
// if (isset($_GET['editid'])) {
//   $sqledit = "SELECT * FROM alumni WHERE alumniid='" . $_GET['editid'] . "'";
...
<head>
    ...
    <title>Alumni Feedback - Alumni Login Window</title>
...
<body>
    ...
    <div class="main">
        ...
        <br>
        <!-- alumni Registration Window -->

        <div class="heading">

            <h1 style="font-weight: bold; margin-bottom:0px ">Alumni Registration</h1>
        </div>
                ...
                <div class="content">
                    <form method="post" action="" onsubmit="return confirmvalidation()" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="alumniname" id="alumniname"
                                placeholder="Enter Your Full Name" value="<?php if (isset($rsedit['alumniname'])) {
    echo $rsedit['alumniname'];
}?>">
                            <span id="alumninameError" class="error" style="display: none;"></span>
                        </div><br>

                        <div class="col-md-12">
                            <label for="inputEmail4" class="form-label">Email</label>
                            <input type="text" class="form-control" name="email_id" placeholder="Enter Your Email Id"
                                id="email_id" value="<?php if (isset($rsedit['email_id'])) {
    echo $rsedit['email_id'];
                        ...
                        <div class="col-md-12">
                            <label for="inputContact" class="form-label">Alumni's Contact</label>
                            <input type="text" class="form-control" name="alumni_no" maxlength="10"
                                placeholder="Alumni Contact" id="alumni_no" value="<?php if (isset($rsedit['alumni_no'])) {
    echo $rsedit['alumni_no'];
}?>">
                            <span id="alumnisnoError" class="error" style="display: none;"></span>
                        </div>
                        <br>
                        <div class="col-md-12">
...
?>
                        ...
                        <br>
                        <div class="col-md-12">
                            <label for="input year">PassOut Year</label>
...
?>
                        ...
                        <!-- <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="section" id="section"
                                placeholder="Enter Your Section (Example: A/B/C only in Block Letters)"
                                value=" -->
                        <?php
...
?>
    ...
    document.getElementById('alumninameError').textContent = '';
    document.getElementById('alumninameError').style.display = 'none';
    ...
    document.getElementById('alumnisnoError').textContent = '';
    document.getElementById('alumnisnoError').style.display = 'none';
    ...
    function confirmvalidation() {
        ...
        if (document.getElementById('alumniname').value === '') {
            fieldValidation();
            document.getElementById('alumniname').focus();
            document.getElementById('alumniname').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        }
        ...
        //     isValid = false;
        // }
        else if (document.getElementById('alumni_no').value === '') {
            fieldValidation();
            document.getElementById('alumni_no').focus();
            document.getElementById('alumni_no').scrollIntoView({
                behavior: 'smooth'
            });
            isValid = false;
        } else if (!document.getElementById('alumni_no').value.match(phoneRegexOnlyNo)) {
            fieldValidation();
            document.getElementById('alumni_no').focus();
            document.getElementById('alumni_no').scrollIntoView({
                behavior: 'smooth'
            ...
            isValid = false;
        } else if (!document.getElementById('alumni_no').value.match(phoneRegexMax10Degit)) {
            fieldValidation();
            document.getElementById('alumni_no').focus();
            document.getElementById('alumni_no').scrollIntoView({
                behavior: 'smooth'
    ...
    function validatealumniname() {
        if (document.getElementById('alumniname').value === '') {
            document.getElementById('alumninameError').textContent = 'Original Name should not be empty.';
            document.getElementById('alumninameError').style.display = 'block';
        } else {
            document.getElementById('alumninameError').textContent = '';
            document.getElementById('alumninameError').style.display = 'none';
        }
    ...
    function validatealumniNo() {
        if (document.getElementById('alumni_no').value === '') {
            document.getElementById('alumnisnoError').textContent = 'Alumni No should not be empty';
            document.getElementById('alumnisnoError').style.display = 'block';
        } else if (!document.getElementById('alumni_no').value.match(phoneRegexOnlyNo)) {
            document.getElementById('alumnisnoError').textContent =
                'Please enter a valid phone number (digits and + only).';
            document.getElementById('alumnisnoError').style.display = 'block';
        } else if (!document.getElementById('alumni_no').value.match(phoneRegexMax10Degit)) {
            document.getElementById('alumnisnoError').textContent = 'Please enter a valid 10-digit phone number.';
            document.getElementById('alumnisnoError').style.display = 'block';
        } else {
            document.getElementById('alumnisnoError').textContent = '';
            document.getElementById('alumnisnoError').style.display = 'none';
    ...
    document.getElementById('alumniname').addEventListener('change', validatealumniname);
    ...
    document.getElementById('alumni_no').addEventListener('change', validatealumniNo);
